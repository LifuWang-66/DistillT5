...
class FluxAttnProcessor2_0:
    ...
    def __call__(
        ...
        if encoder_hidden_states is not None:
            ...
            attention_probs = attention_probs[:, :encoder_hidden_states.shape[1],encoder_hidden_states.shape[1]:]
            attention_probs = attention_probs.reshape(batch_size,-1, 32, 32)
            # attention_probs = attention_probs[:]
            # print(attention_probs.shape)
            return hidden_states, encoder_hidden_states, attention_probs
        else:
            return hidden_states
